...
daily_rain_flow_sims_plot_ma3 <- ggplot(rainfall_response_data, aes(x = rainfall_ma3, y = flow_ma3)) +
...
daily_rain_conc_sims_plot_ma3 <- ggplot(rainfall_response_data, aes(x = rainfall_ma3, y = bacteria_conc)) +
  geom_point(color = "darkgray")+
  xlab("log10(Rainfall (mm))") +
...
daily_flow_conc_sims_plot_ma3 <- ggplot(rainfall_response_data, aes(x = flow_ma3, y = bacteria_conc)) +
  geom_point(color = "darkgray")+
  xlab("log10(Flow (cfs))") +
  ylab("log10(Concentration (MPN/100 ml))") +
  scale_x_log10() +
...
daily_rain_flow_sims_plot_ma3
daily_rain_conc_sims_plot_ma3
daily_flow_conc_sims_plot_ma3
rain_flow_conc_plot_ma3 <- plot_grid(daily_rain_flow_sims_plot_ma3, 
                                       daily_rain_conc_sims_plot_ma3, 
                                       daily_flow_conc_sims_plot_ma3,
                                       ncol = 3, labels = c("A", "B", "C"))

rain_flow_conc_plot_ma3
rain_flow_conc_plot
